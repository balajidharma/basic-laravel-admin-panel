<x-admin.wrapper>
    ...
    @can('adminCreate', \App\Models\Role::class)
            ...
            <x-admin.grid.table>
                <x-slot name="head">
                    <tr class="bg-base-200">
                        ...
                        @canany(['adminUpdate', 'adminDelete'], \App\Models\Role::class)
                        <x-admin.grid.th>
                            {{ __('Actions') }}
                        </x-admin.grid.th>
                        @endcanany
                ...
                @foreach($roles as $role)
                    <tr>
                        ...
                        @canany(['adminUpdate', 'adminDelete'], $role)
                        <x-admin.grid.td>
                            <form action="{{ route('admin.role.destroy', $role->id) }}" method="POST">
                                <div>
                                    @can('adminUpdate', $role)
